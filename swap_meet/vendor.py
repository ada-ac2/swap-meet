class Vendor:
    ...
    def swap_items(self, other_vendor, my_item, their_item):
        ...
        :params:
        - (obj) other_vendor: other vendor to switch with
        - (obj) my_item: my item to switch
        - (obj) their_item: other vendor's item to switch
        :returns:
        - (bool) True if items swapped or False
        """
    ...
    def get_by_category(self, category):
        ...
        :params:
        - (str) category: category of items to get
        :returns:
        - (list) result: list of items from category indicated
        """
        result = list(
            filter(
    ...
    def get_best_by_category(self, category=None, list=None):
        """
        Retrieves best condition item in an indicated category or in a
        given list.
        :params:
        - (str) category: category of items to select best of, default=None
        - (list) list: list of items to select best of, default=None
        :returns:
        - (obj) result: item in best condition or None
        """
    ...
    def display_inventory(self, category=''):
        """
        Prints items in inventory for a given category or all inventory if
        no category given.
        :params:
        - (str) category: category of items to display
        """
    ...
    def swap_by_id(self, other_vendor, my_item_id, their_item_id):
        ...
        :params:
        - (obj) other_vendor: other vendor to swap items with
    ...
    def choose_and_swap_items(self, other_vendor, category=''):
        """
        Displays inventory by category (or full inventory), prompts user for id
        selection of items to swap, and swaps items by ids.
        :params:
        - (obj) other_vendor: other vendor to switch items with
        - (str) category: category of items to display for selection,
                            default=''
        :returns:
        - (bool) True if swapped or False
        """
        [vendor.display_inventory(category) for vendor in [self, other_vendor]]
        prompt = 'Please input the item ID you would like to '
        my_item_id = int(input(f'{prompt} give other vendor: '))
        their_item_id = int(input(f'{prompt} receive from other vendor: '))
    ...
    def get_by_category_attribute(self, category, attr, val):
        ...
        :returns:
        - (list) items_by_attr: category items selected by attribute of
                                equivalent value
        """
        items_by_attr = []
    ...
    def swap_by_category_attribute(self, other_vendor, category,
                                   attr, attr_val):
        """
        Swaps items by indicated category and attribute value between two
        vendors.
        :params:
        - (obj) other_vendor: other vendor to swap items with
        ...
        :returns:
        - (bool) result: True if swapped or False
        """
        my_items = self.get_by_category_attribute(category, attr, attr_val)
        their_items = other_vendor.get_by_category_attribute(category,
                                                             attr,
                                                             attr_val)
