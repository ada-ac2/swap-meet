...
def test_swap_best_by_category():
    ...
    tai_inventory_len = len(tai.inventory)
    tai_best_item = tai.get_best_by_category("Decor")
    ...
    jesse_inventary_len = len(jesse.inventory)
    jesse_best_item = jesse.get_best_by_category("Clothing")
    ...
    assert result
    assert len(tai.inventory) == tai_inventory_len # 3
    assert len(jesse.inventory) == jesse_inventary_len  # 3
    assert tai_best_item in jesse.inventory
    assert jesse_best_item in tai.inventory
...
def test_swap_best_by_category_no_match_is_false():
    ...
    assert tai.get_by_category("Clothing") == []
