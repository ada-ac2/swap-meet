...
def test_raise_error_for_empty_vendor_no_matching_items_by_category():
    vendor = Vendor(
        inventory=[]
    )
...
def test_swap_best_by_category():
    ...
    assert item_f in tai.invetory
    assert item_a in tai.invetory
    assert item_b in tai.invetory
    assert item_c in jesse.invetory
    assert item_e in jesse.invetory
    assert item_d in jesse.invetory
