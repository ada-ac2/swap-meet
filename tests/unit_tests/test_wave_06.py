...
def test_get_no_matching_items_by_category():
    ...
    assert [item.get_category() != "Electronics" for item in vendor.inventory]
    assert len(items) == 0
...
def test_swap_best_by_category():
    ...
    assert [item in jesse.inventory for item in [item_c, item_d, item_e]]
    assert [item in tai.inventory for item in [item_f, item_a, item_b]]
...
def test_swap_best_by_category_reordered():
    ...
    assert len(tai.inventory) == 3
    assert len(jesse.inventory) == 3
    assert [item in tai.inventory for item in [item_a, item_b, item_f]]
    assert [item in jesse.inventory for item in [item_c, item_d, item_e]]
...
def test_swap_best_by_category_no_match_is_false():
    ...
    assert len(jesse.inventory) == 3
    assert len(tai.inventory) == 3
    assert [item in tai.inventory for item in [item_a, item_b, item_c]]
    assert [item in jesse.inventory for item in [item_d, item_e, item_f]]
...
def test_swap_best_by_category_no_other_match_is_false():
    ...
    assert len(tai.inventory) == 3
    assert len(jesse.inventory) == 3
    assert [item in tai.inventory for item in [item_c, item_b, item_a]]
    assert [item in jesse.inventory for item in [item_f, item_e, item_d]]