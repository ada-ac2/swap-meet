...
def test_swap_best_by_category_no_match_is_false():
    ...
    assert item_f not in tai.inventory #item_f should not be swapped since tai doesn't have matching item 
...
def test_swap_best_by_category_no_other_match_is_false():
    ...
    assert item_e in jesse.inventory
    assert item_f in jesse.inventory
    assert item_c not in jesse.inventory #item_c should not be swapped since tai doesn't have matching item 